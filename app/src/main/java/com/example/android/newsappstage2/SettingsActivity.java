...
public class SettingsActivity extends AppCompatActivity {
    ...
    private static Preference numberOfEntries, filterBy;
    ...
    public static class NewsAppPreferenceFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            numberOfEntries = findPreference(getString(R.string.settings_display_entries_key));
            bindPreferenceSummaryToValue(numberOfEntries);
